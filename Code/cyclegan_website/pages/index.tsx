        ...
        <Collapse.Group splitted>
          ...
          <Collapse title="Predictions">
            <Grid.Container gap={2} justify="flex-start">
              ...
              <Grid xs={6} sm={3}>
                <CardLink
                  img="/assets/predictions/photo/test/ukiyoe/ours/2014-08-01 17:41:55.jpg"
                  title="Our Test Photo → Ukiyoe"
                  url="/predictions/photo/test/ukiyoe/ours"
                  fontSize="12px"
                />
              </Grid>
              <Grid xs={6} sm={3}>
                <CardLink
                  img="/assets/predictions/photo/test/cezanne/authors/2014-08-01 17:41:55.png"
                  title="Author's Test Photo → Cezanne"
                  url="/predictions/photo/test/cezanne/authors"
                  fontSize="12px"
                />
              </Grid>
              <Grid xs={6} sm={3}>
                <CardLink
                  img="/assets/predictions/photo/test/cezanne/ours/2014-08-01 17:41:55.jpg"
                  title="Our Test Photo → Cezanne"
                  url="/predictions/photo/test/cezanne/ours"
                  fontSize="12px"
                />
              </Grid>
              <Grid xs={6} sm={3}>
                <CardLink
                  img="/assets/predictions/photo/test/vangogh/authors/2014-08-01 17:41:55.png"
                  title="Author's Test Photo → Van Gogh"
                  url="/predictions/photo/test/vangogh/authors"
                  fontSize="12px"
                />
              </Grid>
              <Grid xs={6} sm={3}>
